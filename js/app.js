    ...
    return `
      <section class="hero">
        ...
        <div class="container hero-container-centered">
          ...
          <p style="font-weight: 500; font-size: 1.18rem; color: #FFFFFF; margin: 0 auto 0.1rem auto; max-width: 860px; line-height: 1.25; text-align: center; letter-spacing: 0.3px; text-shadow: 0 2px 10px rgba(0, 0, 0, 0.35);">
            Jurusan Manajemen Fakultas Ekonomi dan Bisnis Universitas Trunodjoyo Madura
          </p>
          <p style="font-weight: 400; font-size: 1.02rem; color: #FFFFFF; opacity: 0.92; margin: 0 auto 1.5rem auto; max-width: 760px; line-height: 1.3; text-align: center; letter-spacing: 0.2px; text-shadow: 0 2px 8px rgba(0, 0, 0, 0.3);">
